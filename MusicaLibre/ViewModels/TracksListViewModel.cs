    ...
    public static IComparer<TrackViewModel> GetComparer(TrackSortKeys sort, bool ascending)
    {
        return sort switch
        {
            ...
            TrackSortKeys.SampleRate => ascending
                ? SortExpressionComparer<TrackViewModel>.Ascending(x => x.Model.SampleRate??0)
                : SortExpressionComparer<TrackViewModel>.Descending(x => x.Model.SampleRate??0),
            TrackSortKeys.Channels => ascending
                ? SortExpressionComparer<TrackViewModel>.Ascending(x => x.Model.Channels??0)
                : SortExpressionComparer<TrackViewModel>.Descending(x => x.Model.Channels??0),
